from bank.member.Member.member_260522.member_dao import MemberDAO
from bank.member.Member.member_260522.member import Member
...
if __name__ == '__main__':
    ...
    ms.join(Member('Ethan', '1234', '홍우식'))
    ms.join(Member('Brady', '1111', '형식'))
    ...
    ms.logout()
    print(ms.current_user)
    print(ms.view_member_info('Brady'))
    ms.login(MemberService.ADMIN_ID, MemberService.ADMIN_PASSWORD)
    print(ms.update_member_password('Ethan', '1234', '4321'))
    print(ms.view_member_info('Ethan'))
    print(ms.remove_member('Ethan'))
    print(ms.view_member_info('Ethan'))